...
namespace MandelbrotSet
{
    public partial class Viewer : Form
    {
        ...
        {
            get { return settingsForm.Settings; }
        }
        ...
        private void RenderMandelbrot(double? maxr = null, double? minr = null, double? maxi = null, double? mini = null)
        {
            ...
            Program.Benchmark("Mandelbrot", async () =>
            {
                ...
                SafeInvoke(() =>
                {
                    pictureBox1.Image.Run(img => img.Dispose());
                    ...
                    isRendering = false;
                              ...
                              SafeInvoke(
                                         () =>
                                         lblStatus.Text =
                                         (string.Format("Rendered {0} in {1}ms | {2} {3} {4} {5}", tag, benchmark.Milliseconds, Settings.MaxReal, Settings.MinReal, Settings.MaxImaginary,
                                                        Settings.MinImaginary))));
        }
        ...
        private void pictureBox1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            RenderMandelbrot(((ex + zoomx) * currentxjump) - Math.Abs(Settings.MinReal), ((ex - zoomx) * currentxjump) - Math.Abs(Settings.MinReal),
